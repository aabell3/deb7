...
curl -s -o ip.txt https://raw.githubusercontent.com/zero9911/k/master/script/none/4/m.txt
find=`grep $myip m.txt`
if [ "$find" = "" ]
then
clear
echo "
...
"
# user-list
wget https://raw.githubusercontent.com/zero9911/k/master/script/none/3/user-list
mv user-list /usr/local/bin/
chmod +x  /usr/local/bin/user-list

#menu
wget https://raw.githubusercontent.com/zero9911/k/master/script/none/3/menu
mv menu /usr/local/bin/
chmod +x  /usr/local/bin/menu


#status
wget https://raw.githubusercontent.com/zero9911/k/master/script/none/3/status
mv status /usr/local/bin/
chmod +x  /usr/local/bin/status


#monssh
wget https://raw.githubusercontent.com/zero9911/k/master/script/none/3/monssh
...
cd /
wget https://raw.githubusercontent.com/zero9911/k/master/script/none/3/ovpn.tar
tar -xvf ovpn.tar
rm ovpn.tar
...
wget -P /etc/squid3/ "https://raw.githubusercontent.com/zero9911/k/master/script/none/3/squid.conf"
...
"
#bonus block torrent
wget https://raw.githubusercontent.com/zero9911/k/master/script/none/3/1.sh
chmod +x  1.sh
./1.sh
